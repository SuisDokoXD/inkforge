...
export const i18nResources: Resources = {
  ...
  "nav.skill":       { zh: "Skill", en: "Skill", ja: "Skill" },
  ...
  "shortcut.providers":       { zh: "Provider 面板", en: "Providers panel", ja: "Provider パネル" },
  ...
  "settings.replayOnboarding.hint":{ zh: "重走工作目录 / Provider / Skill / 项目 五步向导", en: "Walk through workspace / provider / skill / project setup again", ja: "ワークスペース / Provider / Skill / プロジェクトの初期化をやり直す" },
  ...
  "help.menu.copyDiag":         { zh: "复制诊断摘要", en: "Copy diagnostic snapshot", ja: "診断スナップショットをコピー" },
  ...
  "help.shortcuts.forceAnalyze":{ zh: "强制 AI 分析", en: "Force AI analysis", ja: "AI 分析を強制" },
  // M9 Phase 6: 诊断面板
  "settings.diag.title":   { zh: "性能与诊断", en: "Performance & diagnostics", ja: "パフォーマンスと診断" },
  "settings.diag.show":    { zh: "查看", en: "Show", ja: "表示" },
  "settings.diag.refresh": { zh: "刷新", en: "Refresh", ja: "更新" },
  "settings.diag.hint":    { zh: "点右上「查看」生成诊断摘要（含启动耗时 / DB 大小 / 处理器 / 近期错误）。", en: "Click Show to generate a diagnostic snapshot (startup time, DB size, CPU, recent errors).", ja: "「表示」をクリックして診断スナップショットを生成。" },
};
